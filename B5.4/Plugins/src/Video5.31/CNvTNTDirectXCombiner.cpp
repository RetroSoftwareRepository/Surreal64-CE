...
CNvTNTDirectXCombiner::CNvTNTDirectXCombiner(CDaedalusRender *pRender)
...
void CNvTNTDirectXCombiner::SetD3DArgument(BYTE val, DWORD &arg0, DWORD &arg1)
{
...
void CNvTNTDirectXCombiner::InitCombinerCycle12(void)
{
	...
	if( combinerIsChanged || m_bCycleChanged || gRDP.texturesAreReloaded )
	{
		...
		{
			m_pD3DRender->D3DSetTexture( 1, LPDIRECT3DTEXTURE8(g_textures[gRSP.curTile].m_lpsTexturePtr) );
		}
	...
	if( combinerIsChanged || m_bCycleChanged )
	{
		...
		{
			if( i>1 ) m_pD3DRender->D3DSetTexture( i, 0 );
			m_pD3DRender->D3DSetTexCoordIndex( i, i );
