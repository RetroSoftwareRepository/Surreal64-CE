...
struct D3DModeInfo
{
    ...
    DWORD	   RefreshRate;     // Pixel format in this mode
...
#ifdef _DEBUG
	void DisplayTextureBuffer(int infoIdx = -1);
	virtual void SaveSurfaceToFile(LPDIRECT3DSURFACE8 surf, int seq);
#endif
...
protected:
	...
	static HRESULT ConfirmDevice( D3DCAPS8* pCaps, DWORD dwBehavior, D3DFORMAT Format );
	...
	static HRESULT			DisplayD3DErrorMsg( HRESULT hr, DWORD dwType );
...
public:
	...
	void LoadTexture(TextureEntry* pEntry);
