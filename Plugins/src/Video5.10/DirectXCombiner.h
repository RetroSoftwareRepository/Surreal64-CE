...
public:
	...
	void SetNumStages(DWORD dwMaxStage);

protected:
	friend class DirectXDeviceBuilder;
	CDirectXColorCombiner(CDaedalusRender *pRender);
	...
	DWORD GetD3DArgument(DWORD val);
...
extern int g_dwDirectXCombinerType;
