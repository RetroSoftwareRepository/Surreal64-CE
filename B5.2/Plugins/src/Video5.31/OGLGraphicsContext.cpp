...
void COGLGraphicsContext::Clear(ClearFlag dwFlags, DWORD color, float depth)
{
	DWORD flag=0;
...
bool COGLGraphicsContext::SetFullscreenMode()
{
	...
	if( windowSetting.uFullScreenFrequency == 0 )
		devMode.dmFields     = DM_PELSWIDTH | DM_PELSHEIGHT | DM_BITSPERPEL ;//| DM_DISPLAYFREQUENCY;
	else
	{
		devMode.dmDisplayFrequency = windowSetting.uFullScreenFrequency;
		devMode.dmFields     = DM_PELSWIDTH | DM_PELSHEIGHT | DM_BITSPERPEL | DM_DISPLAYFREQUENCY;
	}
