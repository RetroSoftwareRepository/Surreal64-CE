...
//Ez0n3 - extern c fix - what ever is calling this must be C
...
extern "C" VOID  WINAPI HalInitiateShutdown(VOID);
extern "C" VOID  WINAPI HalWriteSMBusValue(BYTE, BYTE, BOOL, BYTE);
extern "C" VOID  WINAPI HalReadSMCTrayState(DWORD* state, DWORD* count);
