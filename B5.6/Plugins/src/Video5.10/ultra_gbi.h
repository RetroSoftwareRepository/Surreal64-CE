...
#define G_ZELDAVTX				1		// 1
#define G_ZELDAMODIFYVTX		2
#define G_ZELDACULLDL			3		// 3
#define G_ZELDABRANCHZ			4
#define G_ZELDATRI1				5
#define G_ZELDATRI2				6
#define G_ZELDALINE3D			7
#define	G_ZELDARDPHALF_2		0xf1
#define	G_ZELDASETOTHERMODE_H	0xe3
#define	G_ZELDASETOTHERMODE_L	0xe2
#define	G_ZELDARDPHALF_1		0xe1
#define	G_ZELDASPNOOP			0xe0
#define	G_ZELDAENDDL			0xdf
#define	G_ZELDADL				0xde
#define	G_ZELDALOAD_UCODE		0xdd
#define	G_ZELDAMOVEMEM			0xdc
#define	G_ZELDAMOVEWORD			0xdb
#define	G_ZELDAMTX				0xda
#define G_ZELDAGEOMETRYMODE		0xd9
#define	G_ZELDAPOPMTX			0xd8
#define	G_ZELDATEXTURE			0xd7
#define	G_ZELDASUBMODULE		0xd6
...
#define	CYCTYPE_1CYCLE		0
#define	CYCTYPE_2CYCLE		1
#define	CYCTYPE_COPY		2
#define	CYCTYPE_FILL		3
//#define	G_CYC_1CYCLE		(CYCTYPE_1CYCLE << G_MDSFT_CYCLETYPE)
//#define	G_CYC_2CYCLE		(CYCTYPE_2CYCLE << G_MDSFT_CYCLETYPE)
//#define	G_CYC_COPY			(CYCTYPE_COPY << G_MDSFT_CYCLETYPE)
//#define	G_CYC_FILL			(CYCTYPE_FILL << G_MDSFT_CYCLETYPE)
...
#define G_TT_UNKNOWN		(1 << G_MDSFT_TEXTLUT)
...
# define F3DEX_GBI_2X_G_MV_VIEWPORT	8
# define F3DEX_GBI_2X_G_MV_LIGHT	10
# define F3DEX_GBI_2X_G_MV_POINT	12
# define F3DEX_GBI_2X_G_MV_MATRIX	14		/* NOTE: this is in moveword table */
# define F3DEX_GBI_2X_G_MVO_LOOKATX	(0*24)
# define F3DEX_GBI_2X_G_MVO_LOOKATY	(1*24)
# define F3DEX_GBI_2X_G_MVO_L0	(2*24)
# define F3DEX_GBI_2X_G_MVO_L1	(3*24)
# define F3DEX_GBI_2X_G_MVO_L2	(4*24)
# define F3DEX_GBI_2X_G_MVO_L3	(5*24)
# define F3DEX_GBI_2X_G_MVO_L4	(6*24)
# define F3DEX_GBI_2X_G_MVO_L5	(7*24)
# define F3DEX_GBI_2X_G_MVO_L6	(8*24)
# define F3DEX_GBI_2X_G_MVO_L7	(9*24)
