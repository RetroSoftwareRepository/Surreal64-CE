...
#define RICE_HW_VERTEX (D3DFVF_XYZ | D3DFVF_NORMAL | D3DFVF_DIFFUSE | D3DFVF_TEX0 ) 
		...
		g_pD3DDev->DrawIndexedPrimitiveUP( D3DPT_TRIANGLELIST, 0, gRSP.maxVertexID, gRSP.numVertices/3, g_vtxIndex, D3DFMT_INDEX16 , g_vtxForExternal, sizeof(EXTERNAL_VERTEX) );
	}
