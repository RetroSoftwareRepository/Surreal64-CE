...
//========================================================================
COGLColorCombiner4::COGLColorCombiner4(CDaedalusRender *pRender)
...
COGLColorCombiner2::COGLColorCombiner2(CDaedalusRender *pRender)
...
void COGLColorCombiner4::GenerateCombinerSetting(int index)
{
	...
	if( m_bTex0Enabled || m_bTex1Enabled || gRDP.otherMode.cycle_type  == CYCTYPE_COPY )
	{
		if( m_bTex0Enabled || gRDP.otherMode.cycle_type  == CYCTYPE_COPY )
		{
...
int COGLColorCombiner2::ParseDecodedMux()
{
	...
	for( int unitNo=0; unitNo<generalRes.nStages; unitNo++ )
	{
		...
		unit.rgbArg0 = generalRes.stages[unitNo].colorOp.Arg1;
		unit.rgbArg1 = generalRes.stages[unitNo].colorOp.Arg2;
		unit.rgbArg2 = generalRes.stages[unitNo].colorOp.Arg0;
		unit.alphaArg0 = generalRes.stages[unitNo].alphaOp.Arg1;
		unit.alphaArg1 = generalRes.stages[unitNo].alphaOp.Arg2;
		unit.alphaArg2 = generalRes.stages[unitNo].alphaOp.Arg0;
