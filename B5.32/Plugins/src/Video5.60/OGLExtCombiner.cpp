...
GLint COGLColorCombiner4::MapRGBArgs(BYTE arg)
{
	return RGBArgsMap4[arg&MUX_MASK];
}

GLint COGLColorCombiner4v2::MapRGBArgs(BYTE arg)
{
	return RGBArgsMap4v2[arg&MUX_MASK];
}

GLint COGLColorCombiner2::MapRGBArgs(BYTE arg)
{
	return RGBArgsMap2[arg&MUX_MASK];
}

GLint COGLColorCombiner4::MapRGBArgFlags(BYTE arg)
{
...
GLint COGLColorCombiner4::MapAlphaArgs(BYTE arg)
{
	return RGBArgsMap4[arg&MUX_MASK];
}

GLint COGLColorCombiner4v2::MapAlphaArgs(BYTE arg)
{
	return RGBArgsMap4v2[arg&MUX_MASK];
}

GLint COGLColorCombiner2::MapAlphaArgs(BYTE arg)
{
	return RGBArgsMap2[arg&MUX_MASK];
}

GLint COGLColorCombiner4::MapAlphaArgFlags(BYTE arg)
{
...
void COGLColorCombiner4v2::GenerateCombinerSettingConstants(int index)
{
	...
	if( res.envIsUsed )
	{
		...
		TextureEntry *pEntry = gTextureManager.GetConstantColorTexture(MUX_ENV);
	...
	if( res.lodFracIsUsed)
	{
		...
		TextureEntry *pEntry = gTextureManager.GetConstantColorTexture(MUX_LODFRAC);
...
int COGLColorCombiner2::ParseDecodedMux()
{
	...
	for( int unitNo=0; unitNo<generalRes.nStages; unitNo++ )
	{
		...
		unit.rgbArg0 = (BYTE)generalRes.stages[unitNo].colorOp.Arg1;
		unit.rgbArg1 = (BYTE)generalRes.stages[unitNo].colorOp.Arg2;
		unit.rgbArg2 = (BYTE)generalRes.stages[unitNo].colorOp.Arg0;
		unit.alphaArg0 = (BYTE)generalRes.stages[unitNo].alphaOp.Arg1;
		unit.alphaArg1 = (BYTE)generalRes.stages[unitNo].alphaOp.Arg2;
		unit.alphaArg2 = (BYTE)generalRes.stages[unitNo].alphaOp.Arg0;
