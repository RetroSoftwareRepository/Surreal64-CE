...
public:
	...
	virtual CTexture * CreateTexture(DWORD dwWidth, DWORD dwHeight, TextureUsage usage = AS_NORMAL)=0;
...
public:
	...
	CTexture * CreateTexture(DWORD dwWidth, DWORD dwHeight, TextureUsage usage = AS_NORMAL);
