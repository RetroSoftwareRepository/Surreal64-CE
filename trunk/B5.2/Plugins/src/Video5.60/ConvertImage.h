...
static const WORD FourToSixteen[16] = 
{
...
#define R4G4B4A4_MAKE(r,g,b,a) 	((WORD)(((a) << 12) | ((r)<< 8) | ((g)<<4) | (b)))
...
inline DWORD ConvertIA4ToRGBA(BYTE IA4)
{
	DWORD I = ThreeToEight[(IA4 & 0x0F) >> 1];
	DWORD A = OneToEight[(IA4 & 0x01)];		
	return COLOR_RGBA(I, I, I, A);
}

inline WORD ConvertIA4ToR4G4B4A4(BYTE IA4)
{
	DWORD I = ThreeToFour[(IA4 & 0x0F) >> 1];
	DWORD A = OneToFour[(IA4 & 0x01)];		
	return R4G4B4A4_MAKE(I, I, I, A);
}
inline DWORD ConvertI4ToRGBA(BYTE I4)
{
	DWORD I = FourToEight[I4 & 0x0F];
	return COLOR_RGBA(I, I, I, I);
}

inline WORD ConvertI4ToR4G4B4A4(BYTE I4)
{
...
void ConvertCI4( CTexture *pTexture, const TextureInfo & ti );
void ConvertCI8( CTexture *pTexture, const TextureInfo & ti );
...
void ConvertCI4_16( CTexture *pTexture, const TextureInfo & ti );
void ConvertCI8_16( CTexture *pTexture, const TextureInfo & ti );
