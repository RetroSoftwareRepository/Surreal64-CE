...
#define GETREGS \
        rs=(int *)&st.g[OP_RS(opcode)].d; \
        rt=(int *)&st.g[OP_RT(opcode)].d; \
        rd=(int *)&st.g[OP_RD(opcode)].d;

#define GETREGSIMM \
        rs=(int *)&st.g[OP_RS(opcode)].d; \
        rd=(int *)&st.g[OP_RT(opcode)].d; \
...
//        logi("doubleword store at (%08X)\n",st.pc);
    ...
    case 25: // DADDIU
        GETREGSIMM64;
        addi64((dword *)rd,(dword *)rs,(dword *)rt);
        break;
    case 10: // SLTI
        GETREGSIMM;
        *rd=((int)*rs < (int)*rt);
...
//        print("at %08X lui %04X\n",st.pc,(*rt)&0xffff);
    ...
    case 0x40+12: // SYSCALL
        xception("opcode syscall");
        break;
    case 0x40+13: // BREAK
        xception("opcode break");
        break;
    case 0x40+16: // MFHI
        GETREGS;
        rd[0]=st.mhi.d2[0];
