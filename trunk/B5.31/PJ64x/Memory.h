 ...
 *
 */
#define LargeCompileBufferSize	0x03000000
extern DWORD g_dwNormalCompileBufferSize;

extern DWORD *TLB_ReadMap, *TLB_WriteMap, RdramSize, SystemRdramSize;
extern BYTE *N64MEM, *RDRAM, *DMEM, *IMEM, *ROM;
extern void ** XBOXJumpTable, ** XBOXDelaySlotTable;
extern BYTE *XBOXRecompCode, *XBOXRecompPos;
