...
COGLTexture::COGLTexture(DWORD dwWidth, DWORD dwHeight, TextureUsage usage) :
	...
	m_glFmt(GL_RGBA)
{
	...
	DEBUGGER_ONLY_IF( logTextures, {DebuggerAppendMsg("New texture: (%d, %d)", dwWidth, dwHeight);});
}
