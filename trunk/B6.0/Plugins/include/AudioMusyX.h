...
are both passed to the DLL in _AUDIO_MUSYX_InitiateAudio will generate an Interrupt from with in 
the plugin.
**********************************************************************************/
#pragma once
#include "Common.h"
...
/******************************************************************
  Function: _AUDIO_MUSYX_AiDacrateChanged
...
/******************************************************************
  Function: _AUDIO_MUSYX_AiLenChanged
  Purpose:  This function is called to notify the dll that the
...
/******************************************************************
  Function: _AUDIO_MUSYX_AiReadLength
...
/******************************************************************
  Function: _AUDIO_MUSYX_AiUpdate
...
/******************************************************************
  Function: _AUDIO_MUSYX_CloseDLL
...
/******************************************************************
  Function: _AUDIO_MUSYX_DllAbout
...
/******************************************************************
  Function: _AUDIO_MUSYX_DllConfig
  Purpose:  This function is optional function that is provided
...
/******************************************************************
  Function: _AUDIO_MUSYX_GetDllInfo
...
/******************************************************************
  Function: _AUDIO_MUSYX_ProcessAList
