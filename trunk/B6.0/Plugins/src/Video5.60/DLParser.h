...
typedef void (*RDPInstruction)(uint32 word0, uint32 word1);
...
#define RDRAM_UBYTE(addr)	(*(BYTE *)(((addr)^3)+g_pRDRAMu8))
...
#define pRDRAM_UBYTE(addr)	((BYTE *)(((addr)^3)+g_pRDRAMu8))
...
// VC7
#if _MSC_VER >= 1300
#define LOG_DL __noop
#else
inline void DL_PF_Noop() {}
#define LOG_DL(x) DL_PF_Noop()
