	...
	:CColorCombiner(pRender), m_pD3DRender((D3DRender*)pRender)
{
	...
	m_bCapsTxtOpLerp = (g_D3DDeviceCaps.TextureOpCaps & D3DTEXOPCAPS_LERP )!=0; // set to true in 5.60 
	...
	m_bCapsTxtOpMulAdd = (g_D3DDeviceCaps.TextureOpCaps & D3DTEXOPCAPS_MULTIPLYADD )!=0; // set to true in 5.60
	...
	DebuggerAppendMsg("Create The default DirectX Combiner, %d stages", m_dwGeneralMaxStages);
}
