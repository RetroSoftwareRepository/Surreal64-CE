...
#define EXPORT_NAME(name) CALL name
#define EXPORT_TYPE(type) EXPORT type
#endif //_XBOX
...
/******************************************************************
  ...
  output:   none
*******************************************************************/ 
EXPORT_TYPE(void) EXPORT_NAME(ChangeWindow) (void);
...
/******************************************************************
  ...
  output:   none
*******************************************************************/ 
EXPORT_TYPE(void) EXPORT_NAME(FBWrite) (uint32, uint32);
...
/************************************************************************/
EXPORT_TYPE(void) EXPORT_NAME(FBGetFrameBufferInfo) (void *pinfo);
...
// XBOX
#ifdef _XBOX
EXPORT_TYPE(void) EXPORT_NAME(DisplayTemporaryMessage) (const char *Message);
