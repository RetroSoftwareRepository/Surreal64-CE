...
typedef union {
	...
	struct {
		uint32	yl:12;	/* Y coordinate of upper left	*/
		uint32	xl:12;	/* X coordinate of upper left	*/
		uint32	cmd:8;	/* command			*/

		uint32	yh:12;	/* Y coordinate of lower right	*/
		uint32	xh:12;	/* X coordinate of lower right	*/
		uint32	tile:3;	/* Tile descriptor index	*/
		uint32	pad1:5;	/* Padding			*/

		uint32	t:16;	/* T texture coord at top left	*/
		uint32	s:16;	/* S texture coord at top left	*/

		uint32	dtdy:16;/* Change in T per change in Y	*/
		uint32	dsdx:16;/* Change in S per change in X	*/
	};
} Gtexrect;
