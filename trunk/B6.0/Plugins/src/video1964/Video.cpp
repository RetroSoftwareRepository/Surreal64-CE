...
//-------------------------------------------------------------------------------------
EXPORT_TYPE(void) EXPORT_NAME(GetDllInfo) ( PLUGIN_INFO * PluginInfo )
{
#ifdef _DEBUG
#if _MSC_VER > 1200
...
EXPORT_TYPE(void) EXPORT_NAME(DllAbout) ( HWND hParent )
{
	char temp[300];
...
EXPORT_TYPE(void) EXPORT_NAME(DllTest) ( HWND hParent )
{
	MsgInfo("TODO: Test");
}

EXPORT_TYPE(void) EXPORT_NAME(DllConfig) ( HWND hParent )
{
#ifndef _XBOX
...
EXPORT_TYPE(void) EXPORT_NAME(DrawScreen) (void)
{
}

//---------------------------------------------------------------------------------------

EXPORT_TYPE(void) EXPORT_NAME(MoveScreen) (int xpos, int ypos)
{ 
}
...
#ifndef _XBOX // XBOX won't use a screensaver
...
//---------------------------------------------------------------------------------------
EXPORT_TYPE(void) EXPORT_NAME(RomClosed) (void)
{
...
EXPORT_TYPE(void) EXPORT_NAME(RomOpen) (void)
{
	...
	LPTHREAD_START_ROUTINE VidThread = (LPTHREAD_START_ROUTINE) &VideoThreadProc;
	LPDWORD* dwThreadID = (LPDWORD) &threadID;
	videoThread = CreateThread( NULL, 4096, VidThread, NULL, NULL, dwThreadID );
...
EXPORT_TYPE(void) EXPORT_NAME(UpdateScreen) (void)
{
#ifdef USING_THREAD
	if (videoThread)
	{
...
EXPORT_TYPE(void) EXPORT_NAME(ViStatusChanged) (void)
{
	g_CritialSection.Lock();
	SetVIScales();
...
//---------------------------------------------------------------------------------------
EXPORT_TYPE(void) EXPORT_NAME(ViWidthChanged) (void)
{
	g_CritialSection.Lock();
	SetVIScales();
	CRender::g_pRender->UpdateClipRectangle();
...
EXPORT_TYPE(BOOL) EXPORT_NAME(GetFullScreenStatus) (void);
EXPORT_TYPE(void) EXPORT_NAME(SetOnScreenText) (char *msg)
{
...
EXPORT_TYPE(BOOL) EXPORT_NAME(InitiateGFX) (GFX_INFO Gfx_Info)
{
...
EXPORT_TYPE(void) EXPORT_NAME(CloseDLL) (void)
{ 
...
EXPORT_TYPE(uint32) EXPORT_NAME(ProcessDListCountCycles) (void)
{
#ifdef USING_THREAD
	if (videoThread)
	{
...
EXPORT_TYPE(void) EXPORT_NAME(ProcessRDPList) (void)
{
#ifdef USING_THREAD
	if (videoThread)
	{
...
EXPORT_TYPE(void) EXPORT_NAME(ProcessDList) (void)
{
#ifdef USING_THREAD
	if (videoThread)
	{
...
/******************************************************************
  ...
  output:   none
*******************************************************************/ 
EXPORT_TYPE(void) EXPORT_NAME(FBWList) (FrameBufferModifyEntry *plist, uint32 size)
{
}
...
EXPORT_TYPE(void) EXPORT_NAME(FBGetFrameBufferInfo) (void *p)
{
...
//EXPORT void CALL FBWrite2(uint32 addr, uint32 size)
//{
//	FrameBufferWriteByCPU(addr, size);
//}

// Plugin spec 1.3 functions
EXPORT_TYPE(void) EXPORT_NAME(ShowCFB) (void)
{
