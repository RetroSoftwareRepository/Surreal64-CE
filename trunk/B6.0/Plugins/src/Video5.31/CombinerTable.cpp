...
GeneralCombinerInfo twostages[]=
{
	...
	*/

	{
		...
		{
			{MULADD(T1,ENVA,DIF), SKIP,		1, true},	// Stage 0
			{MOD(T0,CUR), MOD(T0,DIF),			0, true},	// Stage 1
		}
	},
...

	{
			...
			0x00000000, 0x00000000,	// constant color texture flags
		{
			...
			{MULADD(CUR,PRIMLODFRAC,T0), MOD(T0,CURC), 0, true},	// Stage 1
		}
	},
