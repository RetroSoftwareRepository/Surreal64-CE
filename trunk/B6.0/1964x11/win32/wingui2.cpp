...
void __cdecl DisplayError(char *Message, ...) //format
{
#ifdef _XBOX
	char	Msg[400];
	va_list ap;
	...
	formatTranslated = TranslateStringByString(Message);
...
BOOL LoadPlugins()
{
	SetDefaultOptions(); //surreal old - etempp
	...
	// maybe a check here to make sure everything's in order

	return TRUE; // it's a bool now but there's no check
}
#endif

#ifndef _XBOX //win32 to EOF
/*
 =======================================================================================================================
 =======================================================================================================================
 */
