...
extern void (CALL *_CONTROLLER_DllAbout) (HWND _hWnd);
extern void (CALL *_CONTROLLER_DllConfig) (HWND _hWnd);
extern void (CALL *_CONTROLLER_DllTest) (HWND _hWnd);
...
extern void (CALL *_CONTROLLER_Under_Selecting_DllAbout) (HWND _hWnd);
extern void (CALL *_CONTROLLER_Under_Selecting_DllTest) (HWND _hWnd);
