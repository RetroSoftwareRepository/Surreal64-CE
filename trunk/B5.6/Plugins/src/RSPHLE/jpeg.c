...
void jpg_uncompress(OSTask_t *task)
{
   ...
   do
	...
	for (i=0; i<(jpg_data.h+4); i++)
	  {
	     ...
	     for (j=0; j<8; j++)
	       {
		  m[8 *8+j] = (short)((((long)temp2[i*64+1*8+j] * (long)data[2*8+0^S]*2)+0x8000
			       +((long)temp2[i*64+7*8+j] * (long)data[2*8+1^S]*2))>>16);
		  m[9 *8+j] = (short)((((long)temp2[i*64+5*8+j] * (long)data[2*8+2^S]*2)+0x8000
			       +((long)temp2[i*64+3*8+j] * (long)data[2*8+3^S]*2))>>16);
		  m[10*8+j] = (short)((((long)temp2[i*64+3*8+j] * (long)data[2*8+2^S]*2)+0x8000
			       +((long)temp2[i*64+5*8+j] * (long)data[2*8+4^S]*2))>>16);
		  m[11*8+j] = (short)((((long)temp2[i*64+7*8+j] * (long)data[2*8+0^S]*2)+0x8000
			       +((long)temp2[i*64+1*8+j] * (long)data[2*8+5^S]*2))>>16);
		  
		  m[6 *8+j] = (short)((((long)temp2[i*64+0*8+j] * (long)data[3*8+0^S]*2)+0x8000
		  ...
		  m[13*8+j] = (short)((((long)m[5*8+j] * (long)data[3*8+0^S]*2)+0x8000
			       +((long)m[4*8+j] * (long)data[3*8+1^S]*2))>>16);
		  m[14*8+j] = (short)((((long)m[5*8+j] * (long)data[3*8+0^S]*2)+0x8000
			       +((long)m[4*8+j] * (long)data[3*8+0^S]*2))>>16);
		  
		  m[4 *8+j] = (short)((((long)temp2[i*64+0*8+j] * (long)data[3*8+0^S]*2)+0x8000
			       +((long)temp2[i*64+4*8+j] * (long)data[3*8+0^S]*2))>>16);
		  m[5 *8+j] = (short)((((long)temp2[i*64+6*8+j] * (long)data[3*8+2^S]*2)+0x8000
			       +((long)temp2[i*64+2*8+j] * (long)data[3*8+4^S]*2))>>16);
		  m[7 *8+j] = (short)((((long)temp2[i*64+2*8+j] * (long)data[3*8+2^S]*2)+0x8000
	     ...
	     for (j=0; j<8; j++)
	       {
		  m[8 *8+j] = (short)((((long)m[25*8+j] * (long)data[2*8+0^S]*2)+0x8000
			       +((long)m[31*8+j] * (long)data[2*8+1^S]*2))>>16);
		  m[9 *8+j] = (short)((((long)m[29*8+j] * (long)data[2*8+2^S]*2)+0x8000
			       +((long)m[27*8+j] * (long)data[2*8+3^S]*2))>>16);
		  m[10*8+j] = (short)((((long)m[27*8+j] * (long)data[2*8+2^S]*2)+0x8000
			       +((long)m[29*8+j] * (long)data[2*8+4^S]*2))>>16);
		  m[11*8+j] = (short)((((long)m[31*8+j] * (long)data[2*8+0^S]*2)+0x8000
			       +((long)m[25*8+j] * (long)data[2*8+5^S]*2))>>16);
		  
		  m[6 *8+j] = (short)((((long)m[24*8+j] * (long)data[3*8+0^S]*2)+0x8000
		  ...
		  m[4 *8+j] = (short)((((long)m[24*8+j] * (long)data[3*8+0^S]*2)+0x8000
			       +((long)m[28*8+j] * (long)data[3*8+0^S]*2))>>16);
		  m[5 *8+j] = (short)((((long)m[30*8+j] * (long)data[3*8+2^S]*2)+0x8000
			       +((long)m[26*8+j] * (long)data[3*8+4^S]*2))>>16);
		  m[7 *8+j] = (short)((((long)m[26*8+j] * (long)data[3*8+2^S]*2)+0x8000
	...
	pic += len1/2;
     } while (w-- != 1 && !(*rsp.SP_STATUS_RG & 0x80));
