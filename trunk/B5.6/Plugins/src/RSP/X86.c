...
void RSP_CondMoveEqual(int Destination, int Source) {
	if (ConditionalMove == FALSE) {
		...
		RSP_JneLabel8("label", 0);
		Jump = RecompPos - 1;
		RSP_MoveX86RegToX86Reg(Source, Destination);
		//CPU_Message("     label:");
