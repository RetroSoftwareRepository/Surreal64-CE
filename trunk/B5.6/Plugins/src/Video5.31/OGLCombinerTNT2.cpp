...
GLint COGLColorCombinerTNT2::MapRGBArgs(BYTE arg)
{
	return RGBArgsMap[arg&MUX_MASK];
}

GLint COGLColorCombinerTNT2::MapRGBArgFlags(BYTE arg)
{
...
GLint COGLColorCombinerTNT2::MapAlphaArgs(BYTE arg)
{
	return RGBArgsMap[arg&MUX_MASK];
}

GLint COGLColorCombinerTNT2::MapAlphaArgFlags(BYTE arg)
{
