...
#ifdef _XBOX
void	InitAll1964Options(void); //surreal old

//----------------------------------------------------------------
// This function is called only when 1964 starts
void ReadConfiguration1964( void)
{
	InitAll1964Options();
	return;
}
...
void InitAll1964Options(void)
{
	...
	strcpy(user_set_state_save_directory, default_save_directory);
	...
	//defaultoptions.Counter_Factor = COUTERFACTOR_2; // Ez0n3 - etemp - 0.85
	defaultoptions.Counter_Factor = COUTERFACTOR_3; // Ez0n3 - etemp - 1.1
...
void ReadConfiguration( void)
{
	...
	*/
	...
	emuoptions.auto_apply_cheat_code = 1; //REGISTRY_ReadDWORD( "AutoApplyCheat", 0);
