...
are both passed to the DLL in _AUDIO_AZIMER_InitiateAudio will generate an Interrupt from with in 
the plugin.
**********************************************************************************/
#pragma once
#include "Common.h"
...
/******************************************************************
  Function: _AUDIO_AZIMER_AiDacrateChanged
...
/******************************************************************
  Function: _AUDIO_AZIMER_AiLenChanged
  Purpose:  This function is called to notify the dll that the
...
/******************************************************************
  Function: _AUDIO_AZIMER_AiReadLength
...
/******************************************************************
  Function: _AUDIO_AZIMER_AiUpdate
...
/******************************************************************
  Function: _AUDIO_AZIMER_CloseDLL
...
/******************************************************************
  Function: _AUDIO_AZIMER_DllAbout
...
/******************************************************************
  Function: _AUDIO_AZIMER_DllConfig
  Purpose:  This function is optional function that is provided
...
/******************************************************************
  Function: _AUDIO_AZIMER_DllTest
  Purpose:  This function is optional function that is provided
...
/******************************************************************
  Function: _AUDIO_AZIMER_GetDllInfo
...
/******************************************************************
  Function: _AUDIO_AZIMER_ProcessAList
...
/******************************************************************
  Function: _AUDIO_AZIMER_RomClosed
