...
//#include "listview.h"
   ...
   void CreateListView( void )
   {
      ...
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_GERMANY ) );
      ImageList_AddIcon( hSmall, hIcon );
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_USA ) );
      ImageList_AddIcon( hSmall, hIcon );
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_JAPAN ) );
      ImageList_AddIcon( hSmall, hIcon );
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_EUROPE ) );
      ImageList_AddIcon( hSmall, hIcon );
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_AUSTRALIA ) );
      ImageList_AddIcon( hSmall, hIcon );
      hIcon = LoadIcon( (HINSTANCE)hInst, MAKEINTRESOURCE( IDI_N64CART ) );
      ImageList_AddIcon( hSmall, hIcon );
