...
{
public:
	virtual void DrawFrameBuffer(bool useVIreg=false, DWORD left=0, DWORD top=0, DWORD width=0, DWORD height=0) {};
	virtual void LoadFrameBuffer(bool useVIreg=false, DWORD left=0, DWORD top=0, DWORD width=0, DWORD height=0) {};
	virtual void DrawFakeFrameBufferIntoD3DRenderTarget(void) {};
	virtual void LoadFakeFrameBuffer(void) {};

	virtual void DrawSprite2D(Sprite2DInfo &info, DWORD ucode) {};
	virtual void LoadSprite2D(Sprite2DInfo &info, DWORD ucode) {};
