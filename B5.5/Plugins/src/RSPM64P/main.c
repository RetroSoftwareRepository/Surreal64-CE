...
void _RSP_M64p_DllConfig (HWND hParent)
{
}

//unsigned int CALL RSP_DoRspCycles(unsigned int Cycles)
...
//void CALL RSP_InitiateRSP(RSP_INFO Rsp_Info, unsigned int *CycleCount)
