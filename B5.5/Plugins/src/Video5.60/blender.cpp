...
#define BLEND_MEM_ALPHA_IN		0x4044	//	Mem * AIn + Mem * AMem
	...
	DWORD blendmode_1 = DWORD( gRDP.otherMode.blender & 0xcccc );
	DWORD blendmode_2 = DWORD( gRDP.otherMode.blender & 0x3333 );
	...
	case CYCLE_TYPE_2:
		...
		*/
		...
		default:
			...
			if( pauseAtNext )
			{
				DWORD dwM1A_1 = (gRDP.otherMode.blender>>14) & 0x3;
				DWORD dwM1B_1 = (gRDP.otherMode.blender>>10) & 0x3;
				DWORD dwM2A_1 = (gRDP.otherMode.blender>>6) & 0x3;
				DWORD dwM2B_1 = (gRDP.otherMode.blender>>2) & 0x3;

				DWORD dwM1A_2 = (gRDP.otherMode.blender>>12) & 0x3;
				DWORD dwM1B_2 = (gRDP.otherMode.blender>>8) & 0x3;
				DWORD dwM2A_2 = (gRDP.otherMode.blender>>4) & 0x3;
				DWORD dwM2B_2 = (gRDP.otherMode.blender   ) & 0x3;
