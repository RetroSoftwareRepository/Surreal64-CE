...
{
	DWORD flag=GL_DEPTH_BUFFER_BIT;
	glClearDepth(depth);
	glClear(flag);
}
...
bool OGLRender::SetCurrentTexture(int tile, CTexture *handler,DWORD dwTileWidth, DWORD dwTileHeight, TextureEntry *pTextureEntry)
{
