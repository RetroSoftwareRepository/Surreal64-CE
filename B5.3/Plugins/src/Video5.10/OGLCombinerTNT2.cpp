...
//========================================================================
COGLColorCombinerTNT2::COGLColorCombinerTNT2(CDaedalusRender *pRender)
...
{
	if( !m_bOGLExtCombinerSupported )	{ COGLExtColorCombiner::InitCombinerCycle12(); return;}
...
GLenum COGLColorCombinerTNT2::MapRGBArgs(BYTE arg)
{
	return RGBArgsMap[arg&MUX_MASK];
}

GLenum COGLColorCombinerTNT2::MapRGBArgFlags(BYTE arg)
{
...
GLenum COGLColorCombinerTNT2::MapAlphaArgs(BYTE arg)
{
	return RGBArgsMap[arg&MUX_MASK];
}

GLenum COGLColorCombinerTNT2::MapAlphaArgFlags(BYTE arg)
{
