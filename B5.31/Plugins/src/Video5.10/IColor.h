...
public:
	...
	IColor(DaedalusColor rgba)
	{
		*((DaedalusColor*)this) = rgba;
	}

	IColor()
	{
		*((DaedalusColor*)this) = 0;
	}

	IColor(D3DXCOLOR &rgba)
	{
		*((DaedalusColor*)this) = DWORD(rgba);
	}

	inline IColor operator = (const IColor &sec) const
	{
		*((DaedalusColor*)this) = *((DaedalusColor*)&sec);
		return *this;
	}

	inline IColor operator = (DaedalusColor col) const
	{
		*((DaedalusColor*)this) = col;
		return *this;
	}
	...
	inline operator DaedalusColor() const
	{
		return *((DaedalusColor*)this);
	}
