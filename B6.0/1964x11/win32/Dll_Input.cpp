...
void (CALL *_CONTROLLER_CloseDLL) (void) = NULL;
void (CALL *_CONTROLLER_ControllerCommand) (int Control, BYTE *Command) = NULL;
void (CALL *_CONTROLLER_DllAbout) (HWND) = NULL;
void (CALL *_CONTROLLER_DllConfig) (HWND) = NULL;
void (CALL *_CONTROLLER_DllTest) (HWND) = NULL;
void (CALL *_CONTROLLER_GetDllInfo) (PLUGIN_INFO *) = NULL;
void (CALL *_CONTROLLER_GetKeys) (int Control, BUTTONS *Keys) = NULL;
void (CALL *_CONTROLLER_InitiateControllers) (HWND hMainWindow, CONTROL Controls[4]) = NULL;
void (CALL *_CONTROLLER_ReadController) (int Control, BYTE *Command) = NULL;
void (CALL *_CONTROLLER_RomClosed) (void) = NULL;
void (CALL *_CONTROLLER_RomOpen) (void) = NULL;
void (CALL *_CONTROLLER_WM_KeyDown) (WPARAM wParam, LPARAM lParam) = NULL;
void (CALL *_CONTROLLER_WM_KeyUp) (WPARAM wParam, LPARAM lParam) = NULL;
void (CALL *_CONTROLLER_Under_Selecting_DllAbout) (HWND) = NULL;
void (CALL *_CONTROLLER_Under_Selecting_DllTest) (HWND) = NULL;

#ifdef _XBOX
void (CALL *_CONTROLLER_SetRumble) (int Control, BOOL on) = NULL;
void (CALL *_CONTROLLER_LoadButtonMap) (byte *cfgData) = NULL;
#endif //_XBOX
...
{
#ifdef _XBOX
	_CONTROLLER_CloseDLL					= _INPUT_CloseDLL;
	_CONTROLLER_ControllerCommand			= _INPUT_ControllerCommand;
	_CONTROLLER_DllAbout					= _INPUT_DllAbout;
	_CONTROLLER_DllConfig					= _INPUT_DllConfig;
	//_CONTROLLER_DllTest					= _INPUT_DllTest;
	_CONTROLLER_GetDllInfo					= _INPUT_GetDllInfo;
	_CONTROLLER_GetKeys						= _INPUT_GetKeys;
	_CONTROLLER_InitiateControllers			= _INPUT_InitiateControllers;
	_CONTROLLER_ReadController				= _INPUT_ReadController;
	_CONTROLLER_RomClosed					= _INPUT_RomClosed;
	_CONTROLLER_RomOpen						= _INPUT_RomOpen;
	_CONTROLLER_WM_KeyDown					= _INPUT_WM_KeyDown;
	_CONTROLLER_WM_KeyUp					= _INPUT_WM_KeyUp;
	
	_CONTROLLER_SetRumble					= _INPUT_SetRumble;
	_CONTROLLER_LoadButtonMap				= _INPUT_LoadButtonMap;
...
void CONTROLLER_SetRumble(int _Control, BOOL _Command)
{
	if(_CONTROLLER_SetRumble != NULL)
	{
		__try
		{
			_CONTROLLER_SetRumble(_Control, _Command);
		}
