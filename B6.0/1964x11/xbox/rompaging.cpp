...
void _MEM_XXX_InitPageAndFrameTables(void);
uint32 _MEM_XXX_ReadUWORDFromROM(uint32 location);
uint16 _MEM_XXX_ReadUHALFFromROM(uint32 location);
uint8  _MEM_XXX_ReadUBYTEFromROM(uint32 location);
__int32 _MEM_XXX_ReadSWORDFromROM(uint32 location);


void _MEM_S10_InitPageAndFrameTables(void);
uint32 _MEM_S10_ReadUWORDFromROM(uint32 location);
uint16 _MEM_S10_ReadUHALFFromROM(uint32 location);
uint8  _MEM_S10_ReadUBYTEFromROM(uint32 location);
__int32 _MEM_S10_ReadSWORDFromROM(uint32 location);
...
void _MEM_S10_InitPageAndFrameTables()
{
	uint32 i;
...
void _MEM_XXX_InitPageAndFrameTables()
{
